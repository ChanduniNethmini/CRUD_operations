    ...
    if (name.length < 2) {
      ...
      axios.post("http://localhost:8000/admincat/save", data).then((res) => {
        if (res.data.success) {
          ...
          swal(
            "Added Successfully",
            "Category/Sub category added successfully",
            "success"
          );
        }
      });
            ...
            <div className="card" style={{ width: "80%" }}>
              <div className="cardedit">
                <div className="col-md-8 mt-4 mx-auto">
                  <h1 className="h3 mb-3 font-weight-normal adminletter text-center ">
                    Category/Sub Category Adding Form
                  </h1>
              ...
              <ul className="list-group">
                <div className="adminletter">
                  <li className="list-group-item">
                    <b>Sofa </b>- 613ce8a4e8e40c670078db6f{" "}
                  </li>
                  <li className="list-group-item">
                    <b>Indoor Furniture</b> - 613ce865e8e40c670078db6d
                  </li>
                  <li className="list-group-item">
                    <b>Outdoor Furniture</b> - 613cf25dc0492711981fd06a{" "}
                  </li>
                  <li className="list-group-item">
                    <b>Mirrors and Hangers</b> - 613ce930e8e40c670078db73{" "}
                  </li>
                  <li className="list-group-item">
                    <b>Office Furniture</b> - 613ce90ae8e40c670078db71
                  </li>
                  <li className="list-group-item">
                    <b>Stainless Steel and Plywood Furniture </b> -
                    613ce98ee8e40c670078db75
                  </li>
                </div>
              </ul>
            </div>
